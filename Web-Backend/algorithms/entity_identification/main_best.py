...
def init_args():
    ...
    argument.add_argument('--cache_dir', type=str, help='pretrained model cache directory', default='/mnt/data10t/bakuphome20210617/yaoxy/Global-Context-Mechanism/bert-base-chinese')
    ...
    argument.add_argument('--best_model', type=str, default='/mnt/data10t/bakuphome20210617/yaoxy/Global-Context-Mechanism/bert-base-chinese_13.pth')
